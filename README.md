...
| [floatpane/matcha](https://github.com/floatpane/matcha) | ⭐ 958 | [#525](https://github.com/floatpane/matcha/pull/525) fix(imap): close debug log file handle to prevent fd leak |
| [lambdaclass/ethrex](https://github.com/lambdaclass/ethrex) | ⭐ 877 | [#6342](https://github.com/lambdaclass/ethrex/pull/6342) fix(levm): validate remaining block gas in parallel pipeline |
...
| [solana-foundation/surfpool](https://github.com/solana-foundation/surfpool) | ⭐ 566 | [#681](https://github.com/solana-foundation/surfpool/pull/681) docs: document Studio UI build inputs |
